---
title: Dubbo——4. Dubbo负载均衡策略
date: 2020-10-25 10:25:23
tags:
- 
categories:
- Dubbo 
...
  这篇文章取自[这篇博客](https://github.com/doocs/advanced-java/blob/master/docs/distributed-system/dubbo-load-balancing.md)，作为整理和收录，方便后续查阅。
...
[1. dubbo-load-balancing](https://github.com/doocs/advanced-java/blob/master/docs/distributed-system/dubbo-load-balancing.md)
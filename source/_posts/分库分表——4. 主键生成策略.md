...
  这篇文章取自[这篇博客](https://github.com/doocs/advanced-java/blob/master/docs/high-concurrency/database-shard-global-id-generate.md)，作为整理和收录，方便后续查阅。
...
[![database-id-sequence-step](https://raw.githubusercontent.com/yangtzeshore/images/main/database/database-id-sequence-step.png)](https://yangtzeshore.github.io/2020/10/21/数据库分库分表-4-主键生成策略/)
...
[1. database-shard-global-id-generate](https://github.com/doocs/advanced-java/blob/master/docs/high-concurrency/database-shard-global-id-generate.md)